...
const ProductDetails = ({ match }) => {
  ...
  const [finalSizeTot, setFinalSizeTot] = useState(product.mediumPrice) 
          ...
          <div className="productCardDiv">
            ...
            <div className="product_card">
                ...
                <Carousel pause='hover'>
                  {product.images && product.images.map(image => (
                    <Carousel.Item key={image.public_id}>
                      <img className="productImg" src={image.url} alt={product.title} />
                    </Carousel.Item>
                  ))}
                </Carousel>
              </div>
              ...
              <div className="desContainer">
                <h1 className="productName" id="productName">{product.name}</h1>
                <br />
                <br />
                <div className="Price-text">
                  <p>Unit Price: Rs.
                  </p><p className="Price" id="unitPrice">{product.mediumPrice}</p>
                  <p />
                </div>
                <br />
                <table className="priceTableCont456">
                  ...
                  <tr>
                    <td>Rs.{product.smallPrice}</td>
                    <td>Rs.{product.mediumPrice}</td>
                    <td>Rs.{product.largePrice}</td>
                  </tr>
                </table>

                <br />
                <p className="decription" id="decription">{product.description}</p>
              </div>
                    ...
                    <div>
                      ...
                      <div className="selectButton">
                        <div className="radio-container">
                          <input id="500g" name="size" type="radio" defaultValue="500g"  onChange={ () => sizeHandler("500g",product.smallPrice)} />
                          <label htmlFor="500g">500 g</label>
                          <input  id="1Kg" name="size"  type="radio" defaultValue="1Kg"  onChange={ () => sizeHandler("1Kg",product.mediumPrice)}  />
                          <label htmlFor="1Kg">1 Kg</label>
                          <input id="2Kg" name="size" type="radio" defaultValue="2Kg" onChange={ () => sizeHandler("2Kg",product.largePrice)}  />
                      ...
                      <div className="selectButton">
                        <div className="radio-container2">
                          ...
                          <input id="1" name="topping" type="radio" defaultValue="1"   onChange={() => toopingHandler("Fresh Fruit", product.freshFruitToppingPrice)} />
                          <label htmlFor="1">Fresh Fruit</label><br />
                          <input id="2" name="topping" type="radio" defaultValue="2"   onChange={() => toopingHandler("Candies and nuts", product.chocolateCandiesAndCashewNutToppingPrice)}  />
                          <label htmlFor="2">Candies & Cashew Nut</label><br />
                          <input id="3" name="topping" type="radio" defaultValue="3"   onChange={() => toopingHandler("Moldable Fondan", product.moldableFondanToppingPrice)} />
