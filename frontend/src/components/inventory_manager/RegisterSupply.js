            ...
            <div className="container_body">
                <div className="left">
                    ...
                    <div className="form">
                        ...
                        <input type="text" className="form-field animation a3" placeholder="Items Code" onChange={(e) => setSuppItemID(e.target.value)} pattern="[T-T]{1}[0-9]{4}" required/>
                        <input type="text" className="form-field animation a3" placeholder="Supplier ID" onChange={(e) => setSupplierID(e.target.value)} pattern="[S-S]{1}[0-9]{4}" required />
